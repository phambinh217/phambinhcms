@extends('Cms::layouts.default',[
	...
	'breadcrumbs' 			=> [
		'title'	=> ['Công việc', 'Học viên của tôi', 'Học viên', trans('cms.edit')],
		'url'	=> [
			route('admin.course.index'),
			admin_url('work/my-student/student'),
		],
	],
])

@section('page_title', 'Chỉnh sửa học viên')
...
@section('content')
	...
	<form action="{{ isset($student_id) ? admin_url('work/my-student/student/' . $student_id)  : admin_url('work/my-student/student') }}" method="post" class="form-horizontal form-bordered form-row-stripped ajax-form">
		@if(isset($student_id))
